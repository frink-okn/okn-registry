...
shortname: evoweb
title: EvoWeb - An Open Knowledge Graph of Co-evolving Genes (NIAID)
description: EvoWeb is a weighted network of protein-protein functional relations, reconstructed from prior knowledge available from genomic sequences, allowing users to find hypothetical proteins involved in protein complexes or separate steps of a biochemical pathway, as well as 12 signals of coevolution to quantify the degree of shared evolution between genes.
