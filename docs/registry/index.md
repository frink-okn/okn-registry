...
| [maudekg](kgs/maudekg/) | FDA MAUDE Adverse Event Knowledge Graph | Knowledge graph constructed from FDA MAUDE adverse event reports using standardized FDA product codes. |
