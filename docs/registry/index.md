...
| [hydrologykg](kgs/hydrologykg/) | SAWGraph Hydrology KG | The Hydrology KG is the part of the SAWGraph project that describes streams, waterbodies and wells and their locations. |
...
| [medical-device-kg](kgs/medical-device-kg/) | Medical Device Knowledge Graph | A unified medical-device knowledge graph integrating regulatory, clinical, research, safety, and other relevant data from multiple sources. |
...
| [ncipidkg](kgs/ncipidkg/) | NCI-PID 2.0 KG | The NCI-PID 2.0 Knowledge Graph converts NCI Pathway Interaction Database version 2.0 networks into RDF, capturing protein interactions, signaling pathways, and post-translational modifications enriched with INDRA evidence metadata. |
| [nde](kgs/nde/) | NIAID Data Ecosystem KG | The nde (NIAID Data Ecosystem) KG contains infectious and immune-mediated disease datasets. These include datasets from NIAID-funded repositories as well as globally-relevant infectious and immune-mediated disease (IID) repositories from NIH and beyond. The datasets include -omics data, clinical data, epidemiological data, pathogen-host interaction data, flow cytometry, and imaging. |
