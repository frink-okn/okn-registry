...
| [medical-device-kg](kgs/medical-device-kg/) | Medical Device Knowledge Graph | Knowledge graph constructed from FDA MAUDE adverse event reports using standardized FDA product codes. |
